...
if isLocked == false
    ...
    coagConstDiff = 2*KB*DROPLET_TEMPERATURE/(3*DYN_VISC); % 1/m³/s, collision rate by brownian diffusion    
...
%% surface volume:  calculate particle size change due to coagulation   

...
geomeandiam = meandiamg(gridDiams_gasPhase, particleConcentrations);
...
output(1, :) = {'d_lock/d_0', 'surfaceShellWidth [nm]', 'time [s]', ...
    'geo. mean diam [nm]', 'geo. std [-]', 'total number concentration [#/m³]'};
output(2, :) = {d_d0, shellWidth, simTime, geomeandiam, geostd, ...
